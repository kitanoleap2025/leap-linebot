...
questions_1_1000 = [
    ...
    {"text": "610 I can r___ everything except temptation.\n私は誘惑以外の全てに耐えうる.",
     "answer": "resist"},
    {"text": "616 o___ a law that doesn’t even exist\nありもしない法に従う🤫",
     "answer": "obey",
    "meaning": ""},
    ...
    {"text": "627 appropriate clothes for an apology p___ conference\n謝罪会見にふさわしい服装🦹",
     "answer": "press"},
    {"text": "628 d___ out a broken heart\n失恋をずるずると引きずる", 
     "answer": "drag",
    "meaning": ""},
    ...
    {"text": "648 s___ school\n学校をサボる",
     "answer": "skip"},
    {"text": "653 make it look as if I a___", 
     "answer": "attended",
    "meaning": ""},
    {"text": "616 obey a law that doesn’t even e___\nありもしない法に従う🤫",
     "answer": "exist",
    "meaning": ""},
    ...
    {"text": "699 r___ my elementary school memories\n小学校の思い出を思い出す",
     "answer": "recall",
    "meaning": ""},
    {"text": "702 a___ a project likely to fail\n失敗するであろう企画を放棄する🚯",
     "answer": "abandon",
    "meaning": ""},
    ...
    {"text": "725 t___ rainforests\n熱帯雨林",
     "answer": "tropical"},
    {"text": "734 a g___ coward\n気前の良い臆病者",
     "answer": "generous",
    "meaning": " "},
    {"text": "736 She is c___.\n彼女は好奇心旺盛だ.",
     "answer": "curious",
    "meaning": " "},
    ...
    {"text": "816 an a___ walk\nぎこちない歩き方",
     "answer": "awkward"},
    {"text": "819 Those twins look a___.\nそのふたごはよく似ている.👦👦",
     "answer": "alike",
    "meaning": ""},
    ...
    {"text": "823 glass f___\nガラスの破片",
     "answer": "fragments"},
    {"text": "826 u___ characteristics\nユニークな特徴",
     "answer": "unique",
    "meaning": " "},
    {"text": "835 Shall we s___ the bill?\n割り勘にしませんか?💰💰",
     "answer": "split"},
    {"text": "839 an enormous a___ of fat\n莫大な(量の)脂肪",
     "answer": "amount"},
    {"text": "840 m___ food waste\n大量の食品廃棄🍟🍟🍟🍟",
     "answer": "mass",
    "meaning": ""},
    ...
    {"text": "854 from the p___ year\n前の年から",
     "answer": "previous",
    "meaning": ""},
    {"text": "856 c___ Japanese society\n現代の日本社会🏙️",
     "answer": "contemporary",
    "meaning": ""},
    ...
    {"text": "924 to p___ E = mc²\nE=mc²を証明する",
     "answer": "prove",
    "meaning": ""},
    {"text": "941 a___ everyone with jokes\n冗談でみんなを笑わせる(楽しませる)",
     "answer": "amuse",
    "meaning": ""},
    ...
    {"text": "978 Complex issues compose themselves of simple, i___ mistakes.\n複雑な問題は,無視された単純なミスから成り立っている.",
     "answer": "ignored",
    "meaning": ""},
    {"text": "997 discover that the speed of light is constant, r___ of the observer’s motion\n光の速度は観測者の運動にかかわらず一定であることを発見する🤪",
     "answer": "regardless",
    "meaning": "regardless	[副] （of ～）（～とは）無関係に"},
    {"text": "998 He's w___ meeting.\n彼に会う価値はある.",
     "answer": "worth",
    "meaning": ""},
