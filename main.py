...
questions_1_1000 = [
    ...
    {"text": "170 No less important than k___ is the ability to question it.\n知識に劣らず重要なのは,それを疑問視する能力です.",
     "answer": "knowledge"},
    {"text": "189 His family celebrated his finally being a___ into college.\n彼の家族は,彼がついに大学に合格したことを祝った.",
     "answer": "accepted"},
    ...
    {"text": "569 [2]Einstein argued that time is r___.\nアインシュタインは時間は相対的だと論じた.",
     "answer": "relative"},
    {"text": "604 Eurasia developed faster because it stretches east to west, so crops could s___ in similar climates.\nユーラシアは東西に広がっているため、作物が似た気候の中で広まりやすく、より早く発展した。",
     "answer": "spread"},
    {"text": "610 I can r___ everything except temptation.\n私は誘惑以外の全てに耐えうる.",
     "answer": "resist"},
    {"text": "627  A job that requires constant b___\nおじぎし続ける仕事",
     "answer": "bowing"},
    {"text": "033 Eurasia developed faster because it s___ east to west, so crops could spread in similar climates.\nユーラシアは東西に広がっているため、作物が似た気候の中で広まりやすく、より早く発展した。",
     "answer": "stretches"},
