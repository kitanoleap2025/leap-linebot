...
questions_1001_1935 = [
    {"text": "1001 p___ travel plan\n旅行の計画を提案する",
     "answer": "propose"},
    {"text": "1002 d___ Takeshi's idea as impossible\n不可能だとしてタケシの考えを退ける",
     "answer": "dismiss"},
    {"text": "1003 I b___ you.\n私はあなたを祝福する.",
     "answer": "bless"},
    {"text": "1004 remember the past g___\n過去の栄光を思い出す",
     "answer": "glory"},
    {"text": "1005 I feel embarrassed when I hear c___.\n褒め言葉を聞いて照れる。",
     "answer": "compliments"},
    {"text": "1006 bored f___\nつまらない宴会",
     "answer": "feast"},
    {"text": "1007 Takeshi d___ that he has never lied.\nタケシは嘘をついたことがないとはっきりと述べた。",
     "answer": "declared"},
    {"text": "1008 h___ an important part\n重要な部分を強調する",
     "answer": "highlight"},
    {"text": "1009 Takeshi's attitude i___ betrayal.\nタケシは裏切りをほのめかす態度だ。",
     "answer": "implies"},
    {"text": "1010 r___ the school song\n校歌を暗唱する",
     "answer": "recite"},
    {"text": "1011 research the sun's r___\n太陽光線を研究する",
     "answer": "rays"},
    {"text": "1012 R___ is not necessarily dangerous.\n放射線は必ずしも危険なものではない。",
     "answer": "radiation"},
    ...
    {"text": "1117 succeed in escaping from ___\n脱獄に成功する",
     "answer": "prison"},
    {"text": "1217 ___ the tale of the Straw Millionaire, trying to exchange a string for a Benz.\nわらしべ長者の物語を省略して,ひもをベンツと交換しようとする.",
     "answer": "Omitting"},
    ...
    {"text": "1247 Don’t count your chickens before they ___.\n卵がかえる前にヒヨコを数えるな🐣",
     "answer": "hatch"},
    {"text": "1359 achieve my a___ to be a pilot\nパイロットになるという望みを叶える🧑‍✈️",
     "answer": "ambition"},
