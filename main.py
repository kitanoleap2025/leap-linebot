...
questions_1_1000 = [
    ...
    {"text": "007 Ancient Greeks ___ about politics more than TikTok.\n古代ギリシャ人は、TikTokよりも政治で口論していた。",
     "answer": "argued"},
    {"text": "007 Einstein ___ that time is relative.\nアインシュタインは時間は相対的だと論じた.",
     "answer": "argued",
    "meaning": "argue	[他] ①（that SV）～と主張する [自] ②（with ～）（～と）言い争う"},
    {"text": "008 He ___ that sleep wasn’t necessary for eaxms.\n彼は試験のために睡眠は必要ないと主張した.",
     "answer": "claimed",
    "meaning": "claim	[他] ①（that SV）～と主張する ②～を要求する，主張する [名] ③主張，要求"},
    {"text": "009 He ___ about buying a math textbook he’d never use.\n彼は使うことのない数学の教科書を買うことに不満を言っていた.",
     "answer": "complained",
    ...
    {"text": "028 ___ shows that sunlight improves mental health.\n研究によると,日光はメンタルヘルスを改善する.🌞",
     "answer": "research",
    "meaning": "research	[名] ①（学術）研究 [他] ②～を研究する"},
    {"text": "029 We need more building ___ to finish the house.\n家を完成させるにはもっと建材が必要だ.🏠",
     "answer": "material",
    "meaning": ""},
    {"text": "030 People who can be replaced by ___ Intelligence\nAIに代替可能な人.",
     "answer": "artificial",
    ...
    {"text": "036 No less important than knowledge is the ___ to question it.\n知識に劣らず重要なのは,それを疑問視する能力です.",
     "answer": "ability",
    "meaning": "ability	[名] 能力"},
    {"text": "037 overwhelming ___\n圧倒的な才能🧬",
     "answer": "talent",
    "meaning": "talent	[名] 才能"},
    {"text": "038 Success often comes after continuous ___.\n成功はたいてい継続的な努力の後にやってくる.",
     "answer": "effort",
    "meaning": "effort	[名] 努力"},
    ...
    {"text": "068 obey a l__ that doesn’t even exist\nありもしない法に従う🤫",
     "answer": "law",
    ...
    {"text": "070 the estimated ___ of Japan\n日本の推定人口🗾",
     "answer": "population",
    "meaning": ""},
    {"text": "071 Does he not have a ___ language?\n彼には母語がないのだろうか？😩",
     "answer": "native",
    "meaning": ""},
    {"text": "072 I want to study ___ after graduating from high school.高校を卒業したら留学したい.",
     "answer": "abroad",
    "meaning": ""},
    {"text": "078 I use ___ transportation to get to school.(不可算)\n私は学校に行くのに公共交通機関を利用しています.",
     "answer": "public",
    ...
    {"text": "083 Paris is the c___ of romance, and overpriced coffee.\nパリはロマンスの都であり、値段の高すぎるコーヒーの都である。",
     "answer": "capital",},
    {"text": "086 The p___ is determined by supply and demand.\n価格は需要と供給で決まる.",
     "answer": "price",
    "meaning": ""},
    {"text": "091 Shall we split the b___?\n割り勘にしませんか?",
     "answer": "bill"},
    {"text": "093 His w___ was huge, but his jokes were bankrupt.\n彼の富は莫大だったが,ジョークは破産状態だった.💰",
     "answer": "wealth",
    "meaning": ""},
    {"text": "094 Consumption tax increases e___ inequality.\n消費税は経済格差を拡大させる.",
     "answer": "economic",
    "meaning": ""},
    {"text": "095 It will ___ fifty dollars extra a month.\nそれは毎月50ドル余分にかかる.",
     "answer": "cost",
    "meaning": ""},
    ...
    {"text": "111 The captain rescued only the ___ from his own country.\n船長は自国の乗客だけを救出しました.",
     "answer": "passengers",
    "meaning": ""},
    {"text": "116 He climbed the ladder of success, then kicked it away so no one else could ___.\n彼は成功のはしごを登り,それを蹴飛ばし,他の誰も追随できないようにした.",
     "answer": "follow"},
    {"text": "117 Not all who ___ are lost.\n彷徨う人全員が迷っているわけではない.",
     "answer": "wander",
    "meaning": ""},
    {"text": "120 abandon a project ___ to fail\n失敗するであろう企画を放棄する🚯",
     "answer": "likely",
    "meaning": ""},
    ...
    {"text": "135 s___ in escaping from prison\n脱獄に成功する",
     "answer": "succeed",
    "meaning": ""},
    {"text": "136 ___ the last train\n終電を逃す",
     "answer": "miss",
    "meaning": ""},
    {"text": "137 abandon a project likely to ___\n失敗するであろう企画を放棄する🚯",
     "answer": "fail",
    "meaning": ""},
    {"text": "138 He ___ silence for wisdom, and loudness for leadership.\n彼は沈黙を賢さと勘違いし,声の大きさをリーダーシップと勘違いした.",
     "answer": "mistook",
    "meaning": ""},
    {"text": "140 They __ Jews from the Nazis.\n彼らはナチスからユダヤ人を隠した.",
     "answer": "hid"},
    {"text": "141 ___ her portrait\n彼女の似顔絵を描く🎨",
     "answer": "draw",
    "meaning": ""},
    ...
    {"text": "150 p___ to understand\nわかっているふりをする",
     "answer": "pretend",
    "meaning": ""},
    {"text": "151 He said something shallow, ___ to be profound.\n彼は深そうに見せかけて浅いことを言った",
     "answer": "pretending",
    "meaning": ""},
    ...
    {"text": "155 More and more problems a___.\nますます多くの問題が現れた.",
     "answer": "appeared",
    "meaning": ""},
    {"text": "157 r___ silent\n黙ったままでいる",
     "answer": "remain",
    "meaning": ""},
    {"text": "162 The list i___ her name.\nリストには彼女の名前が含まれていた.", 
     "answer": "included",
    ...
    {"text": "171 No less important than ___ is the ability to question it.\n知識に劣らず重要なのは,それを疑問視する能力です.",
     "answer": "knowledge",
    "meaning": ""},
    {"text": "364 I’m worried whether he can ___.\n彼が卒業できるのか心配だ.🎓",
     "answer": "graduate",
    "meaning": ""},
    {"text": "177 ___ by appearances, he is selfish.\n見た目で判断すると、彼は自分勝手だ。",
     "answer": "Judging",
    "meaning": ""},
    {"text": "182 I cannot ___ life without her.\n彼女なしの人生なんて想像できない.😍",
     "answer": "imagine",
    "meaning": ""},
    {"text": "187 That ___ me that he was a bad person.\nそれは彼が性格の悪い人だったことを思い出させた.😁",
     "answer": "reminded",
    "meaning": ""},
    {"text": "189 His family celebrated his finally being ___ into college.\n彼の家族は,彼がついに大学に合格したことを祝った.㊗️",
     "answer": "accepted",
    "meaning": ""},
    {"text": "198 First Olympic games ___ only naked men.\n初期オリンピックは裸の男性だけ参加できた。",
     "answer": "allowed",
    "meaning": ""},
    {"text": "194 He ___ to side with the insects.\n彼はその虫の味方をするようだ.🐛",
     "answer": "seems",
    "meaning": ""},
    {"text": "197 ___ on myself for now\n今は自分のことに集中する🔥",
     "answer": "focus",
    "meaning": ""},
    {"text": "202 lose ___ of the destination.\n目的地を見失う🚩",
     "answer": "sight",
    "meaning": ""},
    {"text": "205 the delicate balance of ___\n自然界の絶妙なバランス⚖️",
     "answer": "nature",
    "meaning": ""},
    {"text": "208 Morning glories b___ in the morning.\nアサガオは朝に咲く.💮",
     "answer": "bloom",
    "meaning": ""},
    ...
    {"text": "215 The pond f___ over.\n池が一面凍った.",
     "answer": "froze",
    "meaning": ""},
    {"text": "216 The cherry blossoms are r___ in the stream.\n桜が小川に反射する🌸",
     "answer": "reflicted",
    "meaning": ""},
    {"text": "228 an a___ that doesn’t seem guilty at all\n罪の意識があるとは思えない態度🤪",
     "answer": "attitude",
    "meaning": ""},
    {"text": "230 unique c___\nユニークな特徴",
     "answer": "characteristics",
    "meaning": ""},
    {"text": "236 the c___ answer\n正しい答え✅",
     "answer": "correct",
    "meaning": ""},
    {"text": "237 His “i___ society” suspiciously looks like his bedroom.\n彼の「理想の社会」は、怪しいくらいに彼の寝室にそっくりだ。",
     "answer": "ideal",
    "meaning": ""},
    ...
    {"text": "245 I came up with a b___ idea!\n天才的なアイデアを思いついた!💡",
     "answer": "brilliant",
    "meaning": ""},
    {"text": "246 a l___ corpse\n生き生きとした死体🤡",
     "answer": "lively",
    "meaning": ""},
    {"text": "248 a p___ breeze\n心地よいそよかぜ🍃",
     "answer": "pleasant",
    "meaning": ""},
    {"text": "252 What an a___ problem!\nなんてひどい問題だ!",
     "answer": "awful",
    "meaning": ""},
    {"text": "254 Her top looks t___.\n彼女のトップはきつそうだ.",
     "answer": "tight",
    "meaning": ""},
    {"text": "255 l___ clothes\nゆったりとした服",
     "answer": "loose",
    "meaning": ""},
    {"text": "257 Is your head e___?\nお前の頭の中はからっぽなのか？🤯",
     "answer": "empty",
    "meaning": ""},
    {"text": "258 People tend to accept ideas not because they are true, but because they are f___.\n人々はアイデアが真実だからではなく,馴染みがあるから受け入れる傾向があります.",
     "answer": "familiar",
    "meaning": ""},
    {"text": "268 Consumption tax i___ economic inequality.\n消費税は経済格差を拡大させる.",
     "answer": "increases",
    "meaning": ""},
    {"text": "269 The world is trying to r___ dependence on fossil fuels.\n世界は化石燃料への依存を減らそうとしている.", 
     "answer": "reduce",
    "meaning": ""},
    {"text": "271 Don’t c___ your chickens before they hatch.\n卵がかえる前にヒヨコを数えるな🐣",
     "answer": "count",
    "meaning": ""},
    {"text": "279 It will cost fifty dollars e___ a month.\nそれは毎月50ドル余分にかかる.",
     "answer": "extra",
    "meaning": ""},
    {"text": "280 If you're r___, let's go already!\n準備できているなら,もう行こうよ!",
     "answer": "ready",
    "meaning": ""},
    ...
    {"text": "286 A:What movie has no kissing s___?\nB:Your life.\nA:キスシーンの無い映画は？",
     "answer": "scenes"},
    {"text": "291 Looks like s___ has somehow arrived outdoors.\n外では春が来たようだ.",
     "answer": "spring",
    "meaning": ""},
    ...
    {"text": "294 a g___ gap\n世代間格差",
     "answer": "generation"},
    {"text": "302 A___ Greeks argued about politics more than TikTok.\n古代ギリシャ人は、TikTokよりも政治で口論していた。",
     "answer": "ancient"},
    {"text": "303 The morning will be s___ in the Airin district.\n午前中はあいりん地区で過ごす.",
     "answer": "spent",
    "meaning": ""},
    ...
    {"text": "324 He p___ more than just money to buy his daughter an instrument.\n彼は娘に楽器を買うためにお金以上のものを支払った。",
     "answer": "paid"},
    {"text": "332 It was the s__ of many demonstrations.\nそこは多くのデモが行われた場所だった.",
     "answer": "site",
    "meaning": ""},
    ...
    {"text": "338 The rook moves in the same d___ as the hisha.\nルークは飛車と同じ方向に進む.♟️",
     "answer": "directions"},
    {"text": "339 the symbol of their c___\n彼らの文化の象徴",
     "answer": "culture",
    "meaning": ""},
    ...
    {"text": "362 All America w___.\n全米が泣いた.😢",
     "answer": "wept"},
    {"text": "364 I’m w___ whether he can graduate.\n彼が卒業できるのか心配だ.🎓",
     "answer": "worried",
    "meaning": ""},
    {"text": "366 I am not s___ with my current salary.\n私は今の給料に満足していない.",
     "answer": "satisfied"},
    ...
    {"text": "400 With modern technology, we can talk to anyone in the world e___ the person next to you.\n現代のテクノロジーでは,隣にいる人以外の誰とでも話すことができる.",
     "answer": "except"},
    {"text": "401 The d___ club is basically free entertainment for teachers.\nディベート部は、教師にとってほぼ無料の娯楽だ。",
     "answer": "debate"},
    ...
    {"text": "411 We have a strong d___ to finish our homework.\n私たちは宿題を終わらせたいという強い願望を持っている.",
     "answer": "desire"},
    {"text": "416 History books never m___ who cleaned up after wars.\n歴史の本は、戦争のあとに掃除した人のことは決して書かない。",
     "answer": "mention"},
    {"text": "418 d___ my great wisdom\n自分が賢いということを示す",
     "answer": "demonstrate"},
    {"text": "420 It is not what happened that matters. It is how you r___.\n大事なのは何が起きたかではない.どう応じるかだ.",
     "answer": "respond"},
    {"text": "432 The world is trying to reduce dependence on fossil f___.\n世界は化石燃料への依存を減らそうとしている.", 
     "answer": "fuels",
    "meaning": ""},
    {"text": "433 n___ pencil sharpener\n原子力えんぴつ削り器✏️", 
     "answer": "nuclear",
    "meaning": ""},
    ...
    {"text": "440 the c___ of having to create example sentences to protect copyright\n著作権保護のため例文を作らなければならないという課題",
     "answer": "challenge"},
    {"text": "441 I a___ at him, but the arrow hit the apple on his head.\n私は彼を狙ったが,矢は彼の頭の上のリンゴに当たった.🍎", 
     "answer": "aimed",
    "meaning": ""},
    {"text": "443 Is his face p___ or has it always been p___?\n彼は青ざめているのか,いつも青白いのか.🥶",
     "answer": "pale"},
    {"text": "446 wait to s___ to death\n餓死するのを待つ",
     "answer": "starve"},
    ...
    {"text": "509 The one-child p___ in China is successful to some extent.",
     "answer": "policy",
    "meaning": ""},
    {"text": "514 Consumption t___ increases economic inequality.\n消費税は経済格差を拡大させる.",
     "answer": "tax",
    "meaning": ""},
    {"text": "515 Scholarships help students pay for college tuition and e___.\n奨学金は学生が大学の授業料や費用を支払うのを助ける.",
     "answer": "expenses"},
    {"text": "516 D___ collection notice\n借金の督促状",
     "answer": "debt",
    "meaning": "debt	[名] 借金"},
    ...
    {"text": "527 During World War II, British chess masters were a___ to codebreaking tasks involving the Enigma machine.\n第二次世界大戦中,イギリスのチェスマスターたちはエニグマ機に関わる暗号解読の仕事に就いていました.",
     "answer": "assigned"},
    {"text": "535 He refused to sign the d___.\n彼はその書類にサインするのを拒んだ.",
     "answer": "document"},
    {"text": "536 She works in the sales d___.\n彼女は営業部で働いている.",
     "answer": "department",
    "meaning": ""},
    ...
    {"text": "602 Ideas attach quickest to the minds already half c___.\n考えは半分納得した心に一番早くくっつく.",
     "answer": "convinced"},
    {"text": "604 Fake news ___ faster than real news.\n フェイクニュースは本当のニュースより速く拡散する.",
     "answer": "spreads"},
    {"text": "610 I can ___ everything except temptation.\n私は誘惑以外の全てに耐えうる.",
     "answer": "resist"},
    {"text": "616 ___ a law that doesn’t even exist\nありもしない法に従う🤫",
     "answer": "obey",
    "meaning": ""},
    {"text": "618 Takeshi often ___ his forehead into utility poles.\n タケシはよく電柱に額をぶつける。", 
     "answer": "bumps",
    "meaning": ""},
    {"text": "626 There are times when I ___.\nつまずく時もある.",
     "answer": "stumble"},
    {"text": "627 appropriate clothes for an apology ___ conference\n謝罪会見にふさわしい服装🦹",
     "answer": "press"},
    {"text": "628 ___ out a broken heart\n失恋をずるずると引きずる", 
     "answer": "drag",
    "meaning": ""},
    {"text": "630 I got ___ on the arm by a kitten.\n子猫に腕をひっかかれた.😼",
     "answer": "scratched"},
    {"text": "631 A job that requires constant ___\nおじぎし続ける仕事",
     "answer": "bowing"},
    {"text": "633 She ___.\n彼女はためいきをついた.😮‍💨",
     "answer": "sighed"},
    {"text": "638 ___ the people from the swimming make-up class\n人々を水泳補講から解放する🏊",
     "answer": "release"},
    {"text": "639 succeed in ___ from prison\n脱獄に成功する",
     "answer": "escaping"},
    ...
    {"text": "648 ___ school\n学校をサボる",
     "answer": "skip"},
    {"text": "653 make it look as if I ___", 
     "answer": "attended",
    "meaning": ""},
    {"text": "616 obey a law that doesn’t even ___\nありもしない法に従う🤫",
     "answer": "exist",
    "meaning": ""},
    {"text": "658 During World War II, British chess masters were assigned to codebreaking tasks ___ the Enigma machine.\n第二次世界大戦中,イギリスのチェスマスターたちはエニグマ機に関わる暗号解読の仕事に就いていました.",
     "answer": "involving"},
    {"text": "659 A job that r___ constant bowing\nおじぎし続ける仕事",
     "answer": "requires"},
    {"text": "668 They felt that their happy life would not last long.\n彼らは,自分たちの幸せな生活が長くは続かないと感じていた.",
     "answer": "last"},
    {"text": "669 ___ invitation\n同窓会の案内状",
     "answer": "reunion"},
    {"text": "671 ___ is the basis of clear thinking and good arguments.\n論理は明晰な思考と良い議論の基礎である。",
     "answer": "Logic"},
    {"text": "673 The price is ___ by supply and demand.\n価格は需要と供給で決まる.",
     "answer": "determined"},
    {"text": "682 the ___ population of Japan\n日本の推定人口🗾",
     "answer": "estimated",
    "meaning": ""},
    {"text": "685 Did you ___ the changes in the schedule?\nスケジュールの変更には気付いた？",
     "answer": "notice"},
    {"text": "686 ___ that he is gay\n彼がゲイだと決めつける",
     "answer": "assume",
    "meaning": ""},
    {"text": "691 He was ___ during the entire surgery.\n彼は手術中ずっと意識があった.😱",
     "answer": "conscious"},
    {"text": "693 She is r___ as the best teacher in the school.\n彼女は学校で一番の教師とみなされている.",
     "answer": "regarded"},
    {"text": "694 He c___ himself to finishing the marathon.\n彼はマラソンを完走する事を決意した.",
     "answer": "committed"},
    {"text": "696 ___ the times tables\n九九を暗記する",
     "answer": "memorize"},
    {"text": "697 ___ Gandhi\nガンジーを許す",
     "answer": "forgive"},
    {"text": "698 What is taken for ___ today was once a revolutionary idea.\n今日当たり前のように考えられているものは,かつては革新的なアイデアでした.",
     "answer": "granted"},
    {"text": "699 ___ my elementary school memories\n小学校の思い出を思い出す",
     "answer": "recall",
    "meaning": ""},
    {"text": "702 ___ a project likely to fail\n失敗するであろう企画を放棄する🚯",
     "answer": "abandon",
    "meaning": ""},
    {"text": "717 There are ___ here and there.\nあちらこちらに雑草がある",
     "answer": "weeds",
    "meaning": ""},
    {"text": "720 ___ power generation\n太陽光発電🌞",
     "answer": "solar"},
    {"text": "723 according to the weather ___\n天気予報によれば",
     "answer": "forecast"},
    {"text": "724 The summer in Juso is hot and ___.\n十三の夏は蒸し暑い.",
     "answer": "humid"},
    {"text": "725 ___ rainforests\n熱帯雨林",
     "answer": "tropical"},
    {"text": "734 a ___ coward\n気前の良い臆病者",
     "answer": "generous",
    "meaning": " "},
    {"text": "736 She is ___.\n彼女は好奇心旺盛だ.",
     "answer": "curious",
    ...
    {"text": "740 Judging by appearances, he is s___.\n見た目で判断すると、彼は自分勝手だ",
     "answer": "selfish",
    "meaning": ""},
    {"text": "743 He is a___ to alcohol.\n彼はアルコール中毒になっている.🍺",
     "answer": "addicted",
    "meaning": ""},
    {"text": "744 a s___ old man next door\nお隣の頑固な老人",
     "answer": "stubborn"},
    {"text": "746 an attitude that doesn’t seem g___ at all\n罪の意識があるとは思えない態度🤪",
     "answer": "guilty",
    "meaning": ""},
    ...
    {"text": "751 a___ clock\n正確な時計⌚",
     "answer": "accurate"},
    {"text": "753 a generous c___\n気前の良い臆病者",
     "answer": "coward",
    "meaning": " "},
    {"text": "760 Even a small change can have a ___ effect on society.\n小さな変化でも社会に大きな影響を与える.",
     "answer": "significant",
    "meaning": "society	[名] ①社会〈不可算〉 ②（ある具体的な）社会〈可算〉 ③（one's ―）～と同席すること ④協会"},
    {"text": "761 Don't waste your ___ time.\n貴重な時間を浪費するな.⌛",
     "answer": "precious"},
    {"text": "765 The scientist made a ___ discovery in the laboratory.\nその科学者は研究室で重大な発見をした.",
     "answer": "critical"},
    {"text": "766 He suddenly put on a ___ face.\n彼は急に真剣な顔になった.😐",
     "answer": "serious"},
    {"text": "767 ___ issues compose themselves of simple, ignored mistakes.\n複雑な問題は,無視された単純なミスから成り立っている.",
     "answer": "complex"},
    {"text": "768 a ___ maze\n複雑な迷路",
     "answer": "complicated"},
    {"text": "769 the d___ balance of nature\n自然界の絶妙なバランス⚖️",
     "answer": "delicate",
    "meaning": ""},
    {"text": "772 Everyone admired his remarkable idea.\n誰もが彼の注目すべきアイデアに感心した.",
     "answer": "remarkable",
    "meaning": "admire	[他] ～を称賛する，～に感心する"},
    {"text": "773 His ___ presentation impressed everyone.\n彼の傑出したプレゼンは,みんなに感銘を与えた.",
     "answer": "outstanding",
    "meaning": "impress	[他] ～に感銘を与える，～を感心させる"},
    {"text": "779 He simply finds pleasure in the ___ walk.\n彼はただ着実な歩みを楽しんでいるのです。",
     "answer": "steady"},
    {"text": "783 ___ mango\n熟したマンゴー🥭",
     "answer": "ripe",
    "meaning": ""},
    {"text": "791 ___ news spreads faster than real news.\n フェイクニュースは本当のニュースより速く拡散する.",
     "answer": "Fake"},
    {"text": "803 b___ shoes\n新品の靴👟",
     "answer": "brand-new"},
    {"text": "807 He said something s___, pretending to be profound.\n彼は深そうに見せかけて浅いことを言った",
     "answer": "shallow",
    "meaning": ""},
    {"text": "808 First Olympic games allowed only ___ men.\n初期オリンピックは裸の男性だけ参加できた.🔥",
     "answer": "naked"},
    {"text": "811 Many African countries became ___ in 1960.\n1960年に多くのアフリカの国が独立した",
     "answer": "independent"},
    {"text": "816 an ___ walk\nぎこちない歩き方",
     "answer": "awkward"},
    {"text": "819 Those twins look ___.\nそのふたごはよく似ている.👦👦",
     "answer": "alike",
    "meaning": ""},
    ...
    {"text": "823 glass ___\nガラスの破片",
     "answer": "fragments"},
    {"text": "826 ___ characteristics\nユニークな特徴",
     "answer": "unique",
    "meaning": " "},
    {"text": "835 Shall we ___ the bill?\n割り勘にしませんか?💰💰",
     "answer": "split"},
    {"text": "839 an enormous ___ of fat\n莫大な(量の)脂肪",
     "answer": "amount"},
    {"text": "840 ___ food waste\n大量の食品廃棄🍟🍟🍟🍟",
     "answer": "mass",
    "meaning": ""},
    ...
    {"text": "851 I am not satisfied with my c___ salary.\n私は今の給料に満足していない.",
     "answer": "current"},
    {"text": "854 from the p___ year\n前の年から",
     "answer": "previous",
    "meaning": ""},
    {"text": "856 ___ Japanese society\n現代の日本社会🏙️",
     "answer": "contemporary",
    "meaning": ""},
    {"text": "857 I have noy heard from her ___.\n最近彼女から連絡がない.",
     "answer": "lately"},
    {"text": "860 He was forbidden to go out for nearly a ___.\n彼は10年近く外出を禁止された.",
     "answer": "decade"},
    {"text": "861 The price is determined by ___ and demand.\n価格は需要と供給で決まる.",
     "answer": "supply"},
    {"text": "862 People who can be ___ by Artificial Intelligence\nAIに代替可能な人.",
     "answer": "replaced"},
    {"text": "863 Omitting the tale of the Straw Millionaire, trying to ___ a string for a Benz.\nわらしべ長者の物語を省略して,ひもをベンツと交換しようとする.",
     "answer": "exchange"},
    {"text": "867 ___ drugs\nクスリを配達する🌿",
     "answer": "deliver"},
    {"text": "869 an ___ with a cute design\n可愛らしい柄の封筒",
     "answer": "envelope"},
    {"text": "877 answer a ___\nアンケートに答える",
    ...
    "meaning": ""},
    {"text": "894 Liberty is ___.\n 自由が保障される。", 
     "answer": "guaranteed",
    "meaning": ""},
    {"text": "898 get ___ at 21\n21で離婚する🤰",
     "answer": "divorced",
    "meaning": ""},
    {"text": "901 I want to ___ to the art course.\n美術コースに転向したい.🎨",
     "answer": "transfer",
    "meaning": ""},
    {"text": "906 cover one’s ___\n足跡を消す👣",
     "answer": "tracks",
    "meaning": ""},
    {"text": "907 The morning will be spent in the Airin d___.\n午前中はあいりん地区で過ごす.",
     "answer": "district",
    "meaning": ""},
    {"text": "908 The only good thing about this ___ is that the chair spins.\nこの施設の唯一良い所は,椅子が回ることだ.",
     "answer": "facility",
    "meaning": ""},
    {"text": "910 a ___ relative, that is, a stranger\n遠い親戚,つまり他人",
     "answer": "distant"},
    {"text": "915 Mesopotamian ___\nメソポタミア文明",
     "answer": "civilization",
    "meaning": ""},
    {"text": "919 Russian ___\nロシア文学",
     "answer": "literature",
    "meaning": ""},
    {"text": "924 p___\nことわざ",
     "answer": "proverb",
    "meaning": ""},
    {"text": "925 Omitting the ___ of the Straw Millionaire, trying to exchange a string for a Benz.\nわらしべ長者の物語を省略して,ひもをベンツと交換しようとする.",
     "answer": "tale",
    "meaning": ""},
    {"text": "924 to ___ E = mc²\nE=mc²を証明する",
     "answer": "prove",
    "meaning": ""},
    {"text": "941 ___ everyone with jokes\n冗談でみんなを笑わせる(楽しませる)",
     "answer": "amuse",
    "meaning": ""},
    {"text": "942 The pop star’s cheating scandal ___ media attention.\n人気スターの不倫騒動はマスコミの関心を引き付けた.",
     "answer": "attracted",
    "meaning": ""},
    {"text": "949 be ___ in programming\nプログラミングに没頭する",
     "answer": "absorbed",
    "meaning": ""},
    {"text": "950 I am ___ of reading books.\n本を読むことが好きだ.📚",
     "answer": "fond",
    "meaning": ""},
    {"text": "953 ___ feast\nつまらない宴会",
     "answer": "bored",
    "meaning": ""},
    {"text": "956 I feel ___ when I hear compliments.\n褒め言葉を聞いて照れる.",
     "answer": "embarrassed",
    "meaning": ""},
    ...
    {"text": "960 I’m r___ to study Japanese.\n国語を勉強するのは気が進まない.",
     "answer": "reluctant",
    "meaning": ""},
    {"text": "961 I t___ with longing to see you.\n会いたくて震える.🎵",
     "answer": "tremble",
    "meaning": ""},
    {"text": "968 show my ___\n感情をむき出しにする🤬",
     "answer": "emotions",
    "meaning": ""},
    {"text": "972 have the ___ to say no\n断る勇気を持つ",
     "answer": "courage",
    "meaning": ""},
    {"text": """978 They described ___ the group project as "respecting individual effort".\n彼らはグループ課題を無視することを「個人の努力を尊重する」と表現しました.""",
     "answer": "ignoring",
    "meaning": ""},
    {"text": "983 The one-child policy in China is successful to some ___.",
     "answer": "extent",
    "meaning": ""},
    ...
    {"text": "993 He argued that sleep wasn’t ___ for eaxms.\n彼は試験のために睡眠は必要ないと主張した.",
     "answer": "necessary",
    "meaning": ""},
    {"text": "994 ___ speaking,\n率直に言うと,",
     "answer": "Frankly",
    "meaning": ""},
    {"text": "978 Complex issues compose themselves of simple, ___ mistakes.\n複雑な問題は,無視された単純なミスから成り立っている.",
     "answer": "ignored",
    "meaning": ""},
    {"text": "997 discover that the speed of light is constant, ___ of the observer’s motion\n光の速度は観測者の運動にかかわらず一定であることを発見する🤪",
     "answer": "regardless",
    "meaning": "regardless	[副] （of ～）（～とは）無関係に"},
    {"text": "998 He's ___ meeting.\n彼に会う価値はある.",
     "answer": "worth",
    "meaning": ""},
    {"text": "1000 ___ capitalism, your value peaks at checkout.\n資本主義によると,あなたの価値はチェックアウト時にピークに達する.",
     "answer": "according to",
...
questions_1001_2000 = [
    ...
    {"text": "1059 ___ is blind, but apparently not deaf to bribes.\n正義は目が見えないが、賄賂にはどうやら耳が聞こえるらしい。", 
     "answer": "justice",},
    {"text": "1072 abandon a p___ likely to fail\n失敗するであろう企画を放棄する🚯",
     "answer": "project",
    "meaning": ""},
    ...
    {"text": "1228 The cherry blossoms are reflected in the ___.\n桜が小川に反射する🌸",
     "answer": "stream",
    "meaning": ""},
    ...
    {"text": "1395 Mary is ___ a teather.\nメアリーは1人の教師に過ぎない.(提供)",
     "answer": "merely",
    "meaning": "entire	[形] すべての"},
    {"text": "1397 Looks like spring has s___ arrived outdoors.\n外では春が来たようだ.",
     "answer": "somehow",
    "meaning": ""},
    {"text": "1475 appropriate clothes for an apology press ___\n謝罪会見にふさわしい服装🦹",
     "answer": "conference",
    "meaning": "conference	[名] (on ～)(～に関する)会議"},
    {"text": "1529 His wealth was huge, but his jokes were ___.\n彼の富は莫大だったが,ジョークは破産状態だった.💰",
     "answer": "bankrupt",
    "meaning": ""},
    {"text": "1551 Consumption tax increases economic i___.\n消費税は経済格差を拡大させる.",
     "answer": "inequality",
    "meaning": ""},
    {"text": "1668 The only good thing about this facility is that the chair ___.\nこの施設の唯一良い所は,椅子が回ることだ.",
     "answer": "spins",
    "meaning": ""},
    {"text": "1669 a non-___ globe\n回らない地球儀",
     "answer": "rotating",
    "meaning": ""},
    {"text": "1692 Scholarships help students pay for college ___ and expenses.\n奨学金は学生が大学の授業料や費用を支払うのを助ける.",
     "answer": "tuition",
    "meaning": "tuition	[名] ①〈米〉授業料 ②(少人数での)授業"},
    {"text": "1728 ___ education\n義務教育",
     "answer": "compulsory",
    "meaning": "compulsory	[形] ①義務的な ②規定の"},
    {"text": "1749 The world is trying to reduce dependence on ___ fuels.\n世界は化石燃料への依存を減らそうとしている.", 
     "answer": "fossil",
    "meaning": ""},
    {"text": "1795 He said something shallow, pretending to be ___.\n彼は深そうに見せかけて浅いことを言った",
     "answer": "profound",
    "meaning": ""},
    {"text": "1803 ___ woman\n熟女👵",
     "answer": "mature",
    ...
    {"text": "1943 Don't ___ me!\n私をからかうな!", 
     "answer": "tease",
    "meaning": ""},
    {"text": "1950 Everyone was ___ by his noisy electric eraser.\n彼のうるさい電動消しゴムにみんな気を散らされた.",
     "answer": "distracted",
    "meaning": "electric	[形] 電気の，電動の"},
    {"text": "1961 I tremble with ___ to see you.\n会いたくて震える.🎵",
     "answer": "longing",
    "meaning": ""},
