...
questions_1_1000 = [
    ...
    {"text": "007 Ancient Greeks a___ about politics more than TikTok.\n古代ギリシャ人は、TikTokよりも政治で口論していた。",
     "answer": "argued"},
    ...
    {"text": "029 We need more building m___ to finish the house.\n家を完成させるにはもっと建材が必要だ.🏠",
     "answer": "material",
    "meaning": ""},
    ...
    {"text": "071 Does he not have a n___ language?\n彼には母語がないのだろうか？😩",
     "answer": "native",
    "meaning": ""},
    ...
    {"text": "111 The captain rescued only the p___ from his own country.\n船長は自国の乗客だけを救出しました.",
     "answer": "passengers",
    "meaning": ""},
    {"text": "116 He climbed the ladder of success, then kicked it away so no one else could f___.\n彼は成功のはしごを登り,それを蹴飛ばし,他の誰も追随できないようにした.",
     "answer": "follow"},
    {"text": "117 Not all who w___ are lost.\n彷徨う人全員が迷っているわけではない.",
     "answer": "wander",
    "meaning": ""},
    {"text": "120 abandon a project l___ to fail\n失敗するであろう企画を放棄する🚯",
     "answer": "likely",
    "meaning": ""},
    ...
    {"text": "136 m___ the last train\n終電を逃す",
     "answer": "miss",
    "meaning": ""},
    {"text": "137 abandon a project likely to f___\n失敗するであろう企画を放棄する🚯",
     "answer": "fail",
    "meaning": ""},
    {"text": "138 He m___ silence for wisdom, and loudness for leadership.\n彼は沈黙を賢さと勘違いし,声の大きさをリーダーシップと勘違いした.",
     "answer": "mistook",
    "meaning": ""},
    ...
    {"text": "171 No less important than k___ is the ability to question it.\n知識に劣らず重要なのは,それを疑問視する能力です.",
     "answer": "knowledge",
    "meaning": ""},
    {"text": "364 I’m worried whether he can g___.\n彼が卒業できるのか心配だ.🎓",
     "answer": "graduate",
    "meaning": ""},
    {"text": "177 J___ by appearances, he is selfish.\n見た目で判断すると、彼は自分勝手だ。",
     "answer": "judging",
    "meaning": ""},
    {"text": "182 I cannot i___ life without her.\n彼女なしの人生なんて想像できない.😍",
     "answer": "imagine",
    "meaning": ""},
    {"text": "187 That r___ me that he was a bad person.\nそれは彼が性格の悪い人だったことを思い出させた.😁",
     "answer": "reminded",
    "meaning": ""},
    {"text": "189 His family celebrated his finally being ___ into college.\n彼の家族は,彼がついに大学に合格したことを祝った.㊗️",
     "answer": "accepted",
    "meaning": ""},
    {"text": "198 First Olympic games a___ only naked men.\n初期オリンピックは裸の男性だけ参加できた。",
     "answer": "allowed",
    "meaning": ""},
    {"text": "194 He s___ to side with the insects.\n彼はその虫の味方をするようだ.🐛",
     "answer": "seems",
    "meaning": ""},
    {"text": "202 lose s___ of the destination.\n目的地を見失う🚩",
     "answer": "sight",
    "meaning": ""},
    {"text": "205 the delicate balance of n___\n自然界の絶妙なバランス⚖️",
     "answer": "nature",
    "meaning": ""},
